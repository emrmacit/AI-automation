...
export default function LandingPage() {
  return <main className="landing">
    <nav className="landing-nav">
      <Link href="/" className="landing-brand"><span>E</span>Enqivo</Link>
    ...
    <section className="landing-hero">
      <div className="hero-copy">
        ...
        <p>Enqivo answers routine questions with information you approve, then turns serious interest into a clear request you can follow up—without pretending a booking or payment is confirmed.</p>
      ...
      <div className="product-scene" aria-label="Enqivo product preview">
        <div className="scene-orbit" />
        <div className="mini-phone">
          <div className="mini-phone-top"><span>NF</span><div><strong>North & Finch</strong><small>Customer assistant</small></div></div>
          <div className="mini-thread"><p className="from-customer">What services do you offer?</p><p className="from-enqivo">Signature haircut — €48<br />Colour refresh — €82<br />Brow shape — €24</p><p className="from-customer">I’d like to book Friday afternoon.</p><p className="from-enqivo">I’ve saved your request. The team will confirm the details.</p></div>
        </div>
    ...
    <section className="landing-section" id="how-it-works">
      <div className="section-intro"><span className="landing-kicker">HOW ENQIVO WORKS</span><h2>From first question to a useful next step.</h2><p>Your business stays in control. Enqivo uses the information you enter—nothing more.</p></div>
      <div className="steps-grid">
        ...
        <article><span className="step-number">02</span><WandSparkles /><h3>Capture intent</h3><p>When someone wants to book, buy or arrange a viewing, Enqivo turns the message into a structured request.</p></article>
    ...
    <section className="workspace-callout">
      ...
      <div className="workspace-preview">
        <div className="preview-sidebar"><span className="preview-logo">E</span><i /><i /><i /><i /></div>
